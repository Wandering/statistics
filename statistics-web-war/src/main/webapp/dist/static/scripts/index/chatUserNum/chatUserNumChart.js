...
define('static/scripts/index/chatUserNum/chatUserNumChart', ['static/scripts/index/common/businessChart'], function(require, exports, module) {

    module.exports = function() {
        var moduleChart = require('static/scripts/index/common/businessChart');

        moduleChart({
            url: '/statistics/chat/queryLineChartChatUserNum',
            handle: function(param) {
                ...
                require.async(['static/scripts/index/chatUserNum/chatUserNumTable'], function(realTimeDebt) {
