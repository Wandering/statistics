 ...
 */
define('static/scripts/index/renderResource', [], function(require, exports, module) {
    ...
    var resource = {
        ...
        resourceListModel: function(ButtonEvent, token) {
            ...
            $('#form_button').html('');
            $.get('/statistics/resource/getAccountResources?menuCode=' + menuCode + '&token=' + token, function(data) {
