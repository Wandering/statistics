	...
	var Nav = {
		...
		menuCode: {
			...
			dataAnalysis:function(){
				...
				require.async(['static/scripts/index/dataAnalysis/dataAnalysisChart'], function(dataAnalysisChart) {
					dataAnalysisChart();
				});
			},
			/**
			...
			arrearComparData:function(){
				...
				require.async(['static/scripts/index/arrearComparData/arrearComparDataChart'], function(arrearComparDataChart) {
			...
			arrearageImport:function(){
				require.async(['static/scripts/index/arrearageImport/arrearageImportChart'], function(arrearageImport) {
					arrearageImport();
				});
			},
			/**
			...
			classCircle: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/userActiveClass/userActiveClassChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			findTutor: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/userAction/userActionFindTutorChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			userSendClass: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/userSendClass/userSendClassChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			groupMessage: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/chatUserNum/chatUserNumChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			userChatNum: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/userChatNum/chatUserNumChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			jobAnnouncement: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/sendNoticeUserNum/sendNoticeUserNumChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			userSendNoticeNum: function() {
				Nav.changeSection('tmpl_3');
				require.async(['static/scripts/index/userSendNoticeNum/sendNoticeUserNumChart'], function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			fansNum: function() {
				...
				$('#page_0').append('<div class="form-inline" id="form_search">'
										...
										+ '</div>'
									+ '</div>');
				require.async(['static/scripts/index/fansNum/fansNum'], function(module) {
