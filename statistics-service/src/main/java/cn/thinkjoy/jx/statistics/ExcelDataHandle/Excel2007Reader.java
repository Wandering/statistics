...
import cn.thinkjoy.jx.statistics.domain.OriginalArrearTemplate;
...
public class Excel2007Reader extends DefaultHandler {
    ...
    private List<OriginalArrearTemplate> arrearInfoList = new ArrayList();
    ...
    public List<OriginalArrearTemplate> getArrearInfoList() {
        return arrearInfoList;
    }
}