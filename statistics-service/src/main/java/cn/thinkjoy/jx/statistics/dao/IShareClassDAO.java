 ...
 *
 */
public interface IShareClassDAO extends IBaseDAO<ShareClass> {
    ...
    List<ShareClass> queryByPageAndCondition(@Param("condition") Map<String, Object> var1, @Param("offset") int var2, @Param("rows") int var3, @Param("orderBy") String var4, @Param("sortBy") String var5);
