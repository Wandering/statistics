...
/**
 * Created by cheneng on 16/1/19.
 *
 * 日班级用户登录次数汇总
 *
 */
public interface IUserDayWebLoginService<D extends IBaseDAO<T>, T extends BaseDomain> extends IBaseService<D, T>,IPageService<D, T> {
