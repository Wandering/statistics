 ...
 *
 */
@Service("UserDayLoginServiceImpl")
public class UserDayLoginServiceImpl extends AbstractPageService<IBaseDAO<UserDayLogin>,UserDayLogin> implements IUserDayLoginService<IBaseDAO<UserDayLogin>,UserDayLogin> {
    @Autowired
