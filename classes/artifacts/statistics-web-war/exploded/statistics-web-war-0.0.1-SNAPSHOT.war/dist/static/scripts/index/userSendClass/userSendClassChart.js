 ...
 */
define('static/scripts/index/userSendClass/userSendClassChart', ['static/scripts/index/common/businessChart'], function(require, exports, module) {

    module.exports = function() {
        var moduleChart = require('static/scripts/index/common/businessChart');

        moduleChart({
            url: '/statistics/share/queryLineChartUserShareNum',
            handle: function(param) {
                ...
                require.async(['static/scripts/index/userSendClass/userSendClassTable'], function(realTimeDebt) {
