define('static/scripts/index/index', ['sea-modules/bootstrap/bootstrap', 'sea-modules/jquery/cookie/jquery.cookie', 'static/scripts/index/tools', 'static/scripts/index/common/urlConfig', 'static/scripts/index/nav', 'sea-modules/jquery/md5/jQuery.md5'], function (require, exports, module) {
    ...
    $(window).load(function () {
        var nav = require('static/scripts/index/nav');
        ...
        $('#change_pwd').on('click', function () {
            ...
            require.async(['sea-modules/jquery/dialog/jquery.dialog'], function (dialog) {
