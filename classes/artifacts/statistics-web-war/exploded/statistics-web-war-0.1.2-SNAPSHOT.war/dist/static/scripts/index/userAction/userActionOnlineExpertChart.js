 ...
 */
define('static/scripts/index/userAction/userActionOnlineExpertChart', ['static/scripts/index/common/businessChart'], function(require, exports, module) {

    module.exports = function() {
        var moduleChart = require('static/scripts/index/common/businessChart');

        moduleChart({
            url: '/statistics/userAction/queryOnlineExpertActionNum',
