 ...
 */
define('static/scripts/index/userActiveClass/userActiveClassChart', ['static/scripts/index/common/businessChart'], function(require, exports, module) {

    module.exports = function() {
        var moduleChart = require('static/scripts/index/common/businessChart');

        moduleChart({
            url: '/statistics/share/queryLineChartShareUserNum',
            handle: function(param) {
                ...
                require.async(['static/scripts/index/userActiveClass/userActiveClassTable'], function(realTimeDebt) {
