 ...
 */
define('static/scripts/index/articleOrActivity/statistics', ['sea-modules/bootstrap/bootstrap', 'sea-modules/dot/doT.min', 'sea-modules/jquery/cookie/jquery.cookie', 'static/scripts/index/tools', 'sea-modules/bootstrap/datetimepicker/bootstrap-datetimepicker', 'sea-modules/bootstrap/datetimepicker/bootstrap-datetimepicker.zh-CN'], function(require, exports, module) {
    ...
    var Statics = {
        ...
        renderCondition: function() {
            ...
            $('#export_excel').on('click', function(e) {
                ...
                if (date.start && date.end) {
                    window.location.href = '/statistics/article/exportArticle?beginDate=' + date.start + '&endDate=' + date.end;
                }
            });
        },
        /**
        ...
        url: function(startDate, endDate) {
            return this.options.url + '?beginDate=' + startDate + '&endDate=' + endDate;
        },
        /**
         * 7, 30时间处理
         * @param days
