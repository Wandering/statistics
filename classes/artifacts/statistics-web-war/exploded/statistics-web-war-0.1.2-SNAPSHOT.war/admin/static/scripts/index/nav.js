	...
	var Nav = {
		...
		menuCode: {
			...
			companyAuthorityManager:function() {
				$('#page_0').html('');
				require.async('./authority/company', function(module) {
			...
			realTimeStatistics: function() {
				$('#page_0').html('');
				require.async('./realTimeDebt/realTimeDebt', function(realTimeDebt) {
					realTimeDebt();
				});
			},
			/**
			...
			historicalRecords: function() {
				...
				require.async('./pastRecordsDebt/pastDebtChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			dataAnalysis:function(){
				Nav.changeSection('tmpl_4');
				require.async('./dataAnalysis/dataAnalysisChart', function(dataAnalysisChart) {
					dataAnalysisChart();
				});
			},
			/**
			 * 欠费对比
			 */
			arrearComparData:function(){
				Nav.changeSection('tmpl_5');
				require.async('./arrearComparData/arrearComparDataChart', function(arrearComparDataChart) {
					arrearComparDataChart();
				});
			},
			/**
			 * 欠费数据导入
			 */
			arrearageImport:function(){
				require.async('./arrearageImport/arrearageImportChart', function(arrearageImport) {
					arrearageImport();
				});
			},
			/**
			...
			base:function(){
				Nav.changeSection('tmpl_3');
				require.async('./basicStatus/basicStatusChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			classCircle: function() {
				Nav.changeSection('tmpl_3');
				require.async('./userActiveClass/userActiveClassChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			findTutor: function() {
				Nav.changeSection('tmpl_3');
				require.async('./userAction/userActionFindTutorChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			 ...
			 * 用户发送班级圈条数
			 */
			userSendClass: function() {
				Nav.changeSection('tmpl_3');
				require.async('./userSendClass/userSendClassChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			userLoginNum: function() {
				Nav.changeSection('tmpl_3');
				require.async('./userLogin/userLoginChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			userLoginDayNum: function() {
				...
				$('#page_0').append('<div class="form-inline" id="form_search">'
									...
									+ '</div>');
				require.async('./userLoginDayNum/userLoginDayNumChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			webUserLoginNum: function() {
				Nav.changeSection('tmpl_3');
				require.async('./webuserLogin/webuserLoginChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			userLoginNumTimes: function() {
				Nav.changeSection('tmpl_3');
				require.async('./webuserLoginNum/webuserLoginNumChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			groupMessage: function() {
				Nav.changeSection('tmpl_3');
				require.async('./chatUserNum/chatUserNumChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			 * 用户聊天数
			 */
			userChatNum: function() {
				Nav.changeSection('tmpl_3');
				require.async('./userChatNum/chatUserNumChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			 * 作业公告
			 */
			jobAnnouncement: function() {
				Nav.changeSection('tmpl_3');
				require.async('./sendNoticeUserNum/sendNoticeUserNumChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			 * 用户发送公告数
			 */
			userSendNoticeNum: function() {
				Nav.changeSection('tmpl_3');
				require.async('./userSendNoticeNum/sendNoticeUserNumChart', function(pastRecordsDebt) {
					pastRecordsDebt();
				});
			},
			/**
			...
			fansNum: function() {
				...
				$('#page_0').append('<div class="form-inline" id="form_search">'
										...
										+ '</div>'
									+ '</div>');
				require.async('./fansNum/fansNum', function(module) {
					module(UrlConfig.queryOpFans);
				});
			},
			/**
			 * 单个账号统计
			...
			individualAccountStatistics: function() {
				$('#page_0').html('');
				require.async('./individualAccountStatistics/treeAccount', function(module) {
					Nav.treeMenuEntry(module);
				});
			},
			/**
			...
			activeStatistics: function() {
				$('#page_0').html('');
				require.async('./activeStatistics/activeStatisticsChart', function(module) {
					module({
			...
			overallSituation: function() {
				$('#page_0').html('');
				require.async('./overallSituation/treeSituation', function(module) {
					Nav.treeMenuEntry(module);
				});
			},
			/**
			 * 文章统计
			 */
			articleStatistics: function() {
				$('#page_0').html('');
				require.async('./articleOrActivity/statistics', function(module) {
					module({
						url: UrlConfig.queryArticle,
						column: [{
							data:'userName',
							title:'公众账号'
						},{
